...
import com.mobilegame.spaceshooter.logic.model.screen.inGameScreens.motions.MotionsViewModel2
...
class DuelInGameViewModel(application: Application, displaySize: Size): AndroidViewModel(application) {
    ...
    val motionVM = MotionsViewModel2(application, ui.position.pCenterDp, ui.sizes.displayDpDeltaBox)
}