...
import com.mobilegame.spaceshooter.logic.model.screen.menuScreen.MenuScreens
...
class AboutScreenViewModel(): ViewModel() {
    ...
    val backNavHandler = PressureHandler(Screens.MenuScreen, MenuScreens.AboutUs.name)
