...
sealed class Screens(override val route: String, val key: Int, val backNav: Screens):
    ...
    object  TryAgainScreen: Screens("try_again_screen", 5, MainScreen)
    object  SpaceWarScreen: Screens("space_war_screen", 6, MainScreen)
    object  DuelTutoScreen: Screens("duel_tuto_screen", 7, MainScreen)
    object  Creator: Screens("creator_screen", 8, MainScreen)
    object  StatsScreen: Screens("stats_screen", 9, MenuScreen)
