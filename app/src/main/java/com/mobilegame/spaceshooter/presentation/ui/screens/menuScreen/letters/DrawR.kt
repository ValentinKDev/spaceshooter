...
import com.mobilegame.spaceshooter.logic.uiHandler.screens.menu.startMenu.letters.LetterRUI
import com.mobilegame.spaceshooter.presentation.theme.MyColor

@Composable
fun DrawR(menuUI: MenuScreenUI) {
    val ui: LetterRUI = remember { LetterRUI(menuUI.letterSizeDp) }
