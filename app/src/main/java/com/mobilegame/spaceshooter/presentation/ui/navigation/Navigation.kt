...
import com.mobilegame.spaceshooter.presentation.ui.screens.tutoScreen.TutoScreen
...
//        startDestination = Screens.MainScreen.route
        startDestination = Screens.TutoScreen.route
    ) {
        ...
        composable(route = Screens.TutoScreen.route) { TutoScreen(navigator) }
    }
}
