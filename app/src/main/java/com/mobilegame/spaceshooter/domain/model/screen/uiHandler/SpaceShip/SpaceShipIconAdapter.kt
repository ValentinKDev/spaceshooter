...
class SpaceShipIconAdapter(type: SpaceShipType = SpaceShipType.Default, shipBox: Float) {
    ...
    fun initShip() {
        displayDataUI?.let {
            vLog("SpaceShipIconUI::initShape", "strokeWidth ${sizes.strokeWidth}")
            vLog("SpaceShipIconUI::initShape", "halfWidth ${sizes.halfWidth}")
            vLog("SpaceShipIconUI::initShape", "epsilon ${sizes.epsilon}")
        }
    }
