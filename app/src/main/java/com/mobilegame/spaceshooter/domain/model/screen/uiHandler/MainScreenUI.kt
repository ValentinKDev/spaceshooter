...
class MainScreenUI {
    ...
    class TutorialButton {
        ...
        data class RatiosTutorialButton (
            val iconButtonHeightPercentage: Float = 0.75F,
            val questionMarkHeightPercentage: Float = 0.55F,
            val strokeHeightPercentage: Float = 0.07F,
        )
